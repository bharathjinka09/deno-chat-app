//@ts-nocheck
import { listenAndServe } from "https://deno.land/std@0.54.0/http/server.ts";
import {
  acceptWebSocket,
  acceptable,
  WebSocket,
...
import { fromFileUrl } from "https://deno.land/std@0.54.0/path/mod.ts";
...
console.log("chat server starting on http://127.0.0.1:5000");